...
def pointwise_train_features(train_data_file, train_rel_file):
  ...
  scoresWithDescription =  CalctTFIdfs.GetScores(train_rel_file)

  #featuresWithDescription is in form of tuples like this (query,url,featuresVector)
  featuresWithDescription =  CalctTFIdfs.GetFeatures(train_data_file)
...
def pointwise_test_features(test_data_file):
  index_map = {}
  featuresWithDescription =  CalctTFIdfs.GetFeatures(test_data_file)
